                        ...
                        <form >
                            <div class="form-body">
                                ...
                                <div class="row p-t-20">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group has-danger">
                                            ...
                                            <input type="number" class="form-control" id="card_number" min="0" max="<?php echo $total; ?>" name="card_number" placeholder="card number.." required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group has-danger">
                                            <label class="control-label">Enter Cvv</label>
                                            <input type="number" class="form-control" id="card_number" min="0" max="<?php echo $total; ?>" name="card_number" placeholder="cvv.." required>
                                        </div>
                                    </div>
                                ...
                                <div class="row p-t-20">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group has-danger">
                                            <label class="control-label">Enter Exp date</label>
                                            <input type="text" class="form-control" id="card_number" min="0" max="<?php echo $total; ?>" name="card_number" placeholder="exp date.." required>
                                        </div>
                                    </div>
                                </div>
