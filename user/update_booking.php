                    ...
                    <div class="card-body">
                        <form action="user_operations/booking.php?edit_id=<?php echo $id; ?>" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="traveller_id" class="form-control" required>
                                                ...
                                                foreach ($expense_sel as $package) { ?>
                                                    <option value="<?php echo $package['id'] ?>"><?php echo $package['name'];
                                                                                                $expense_sel = $package['name']; ?></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="package_id" id="package_id" onchange="calculate();" class="form-control" required>
                                                ...
                                                foreach ($packages as $value) { ?>
                                                    <option value="<?php echo $value['id'] . ',' . $value['price_adult'] . ',' . $value['price_children'] ?>" <?php if ($value['id'] == $package_id) {
                                                                                                                                                            echo "selected";
                            ...
                            <div class="form-actions">
                                ...
                                <a href="my_bookings.php"><button type="button" class="btn btn-inverse">Cancel</button></a>
                            </div>
                        </form>
                    </div>
                </div>
