...
<div class="page-wrapper">
                        ...
                        <form action="user_operations/booking.php" method="post">
                            <div class="form-body">
                                ...
                                <div class="row p-t-20">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label">Select Vehical </label>
                                            <select name="vehical"  class="form-control custom-select" required>
                                                <option value=""> Select Vehical</option>
                                                <?php
                                                foreach ($vehicals as $value) { ?>
                                                    <option value="<?php echo $value['vtype'] ?>"><?php echo $value['vtype']; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group has-danger">
                                            ...
                                            <input type="number" min="0" onchange="calculate();" onkeyup="calculate();" class="form-control" id="no_of_offices" name="no_of_offices" placeholder="Enter no of adults.." required>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group has-danger">
                                            ...
                                            <input type="number" min="0" onchange="calculate();" onkeyup="calculate();" class="form-control" id="no_of_desk" name="no_of_desk" placeholder="Enter No of Children.." required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group has-danger">
                                            ...
                                            <input type="text" class="form-control" id="total_amount" name="total_amount" placeholder=" SubTotal Amount.." required readonly>
                                        </div>
                                    </div>
                                ...
                                <div class="row p-t-20">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group has-danger">
                                            ...
                                            <input type="text" class="form-control" id="ttt2" name="total" placeholder="Total Amount.." required readonly>
                                        </div>
                                    </div>
                            ...
                            <div class="form-actions">
                                ...
                                <button type="submit" class="btn btn-success" name="submit" id="btnValidate"> <i class="fa fa-check"></i>Make Payment</button>
                                <a href="booking_details"><button type="button" class="btn btn-inverse">Cancel</button></a>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <script>
        function calculate() {
            ...
            var total = (parseInt(price_adult) * parseInt(no_of_offices)) + (parseInt(price_children) * parseInt(no_of_desk));
