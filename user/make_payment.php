            ...
            <div class="col-lg-12">
                ...
                <div class="card card-outline-primary">
                    <div class="card-body">
                        <form  >
                            <div class="form-body">
                                <h3 class="card-title m-t-15">Select Payment Method </h3>
                                <hr>
                                ...
                                <div class="row p-t-20">
                                    ...
                                    <div class="col-md-6">
                                            <div class="form-group has-danger">
                                                ...
                                                <a href="card_payment .php"><button type="button" class="btn btn-success" name="submit" id="btnValidate"> <i class="fa fa-card"></i>Pay With Card</button> </a>
                                                <a href="upi_payment .php"><button type="button" class="btn btn-success" name="submit" id="btnValidate"> <i class="fa fa-upi"></i>Pay With Upi</button> </a>
                                            </div>
                                        </div>
                                </div>
