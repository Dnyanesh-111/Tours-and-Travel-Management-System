  ...
  function Header()
    {
      ...
      $this->SetXY(85, 20);
       $this->Cell(100,10,'Booking Invoice',0,1);
        ...
        $this->cell(33,10,'Package Name',1,0,'',true);
        $this->cell(25,10,'Vehical',1,0,'',true);
...
// $abc=$stmt->fetch(PDO::FETCH_ASSOC);
 ...
 // $xyz=$stmt3->fetch(PDO::FETCH_ASSOC);
      ...
      //echo "<pre>";print_r($stmt6);exit;
          ...
          $pdf->cell(33,10,$package['pname'],1,0);
          $pdf->cell(25,10,$value['vehical'],1,0);
